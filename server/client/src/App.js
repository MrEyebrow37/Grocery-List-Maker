...
const App = () => {
  ...
  const getLocations = (params) => {
    if (params.zipCode.length === 5) {
      fetch("http://localhost:4040/locations", {
        method: "post",
        headers: {
  ...
  const getRecipes = () => {
    ...
    fetch("http://localhost:4040/getRecipes", {
      method: "post",
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  const postRecipes = () => {
    ...
    fetch("http://localhost:4040/recipes", {
      method: "post",
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  const setUserLocation = (location) => {
    ...
    fetch("http://localhost:4040/setZipCode", {
      method: "post",
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  const register = async() => {
    ...
    await fetch("http://localhost:4040/register", {
        method: "post",
        headers: {
          'Content-Type': 'application/json'
        },
